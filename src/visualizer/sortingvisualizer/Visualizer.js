...
import AlgorithmSelector from './component/selectors/algorithmselector/AlgorithmSelector';//gives array of objects {id: ,height:(5,20),isSwap:false }
...
import {
  ...
  SpeedSelectorProps,
} from './component/selectors/sliderselector/SelectorProps';   //object with min max and speed
...
import ButtonBox from './component/button/ButtonBox';          //pause play button
